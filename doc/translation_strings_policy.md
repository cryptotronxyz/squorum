...
This document provides guidelines for internationalization of the sQuorum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `squorum_en.ts` remains unchanged.

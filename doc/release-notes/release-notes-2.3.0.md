...
[
  {
    ...
    winner: {
        address: addr,    (string) Helium MN Address,
...
- #195 `aee05fe` [ZMQ] ZMQ integration for Helium (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with Helium (Fuzzbawls)
